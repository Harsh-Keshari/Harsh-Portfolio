      ...
      <div className="container lg:grid lg:grid-cols-2 items-center lg:gap-10">
        <div>
          ...
          <h2 className="headline-1 max-w-[15ch] sm:max-w-[20ch] lg:max-w-[15ch] mt-5 mb-8 lg:mb-10">
            ...
            <span className="text-4xl">Hello, It's Me</span><br /><span className="text-green-500">Harsh Keshari</span><br />
            <div className="text-2xl pt-2">And I'm a <span className="text-3xl font-bold ">Full-Stack Developer</span></div>
          </h2>
          <div className="flex items-center gap-3">
            <ButtonPrimary
              href="https://drive.google.com/file/d/1JKgEqeotvvKqQ3NxXKHpsp2OqmGiSbhJ/view?usp=drive_link"
              label="Download CV"
              icon="download"
            />
            <ButtonOutline
